...
class BitbucketServer {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            try {
                ...
                if (this.isDangerousTool(toolName) &&
                    ...
                    throw new McpError(ErrorCode.MethodNotFound, `Tool ${toolName} is disabled. Set BITBUCKET_ENABLE_DANGEROUS=true to enable.`);
                }
                switch (request.params.name) {
                    ...
                    case "getPullRequestDiffStat":
                        return await this.getPullRequestDiffStat(args.workspace, args.repo_slug, args.pull_request_id);
                    ...
                    case "getPullRequestTasks":
                        return await this.getPullRequestTasks(args.workspace, args.repo_slug, args.pull_request_id);
                    ...
                    case "getPullRequestStatuses":
                        return await this.getPullRequestStatuses(args.workspace, args.repo_slug, args.pull_request_id);
                    default:
    ...
    async stopPipeline(workspace, repo_slug, pipeline_uuid) {
        try {
            ...
            const response = await this.api.post(`/repositories/${workspace}/${repo_slug}/pipelines/${pipeline_uuid}/stop`);
            return {
                content: [
                    {
                        type: "text",
    ...
    async getPullRequestComment(workspace, repo_slug, pull_request_id, comment_id) {
        try {
            ...
            const response = await this.api.get(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/comments/${comment_id}`);
            return {
                content: [
                    {
                        type: "text",
    ...
    async updatePullRequestComment(workspace, repo_slug, pull_request_id, comment_id, content) {
        try {
            ...
            const response = await this.api.put(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/comments/${comment_id}`, {
                content: { raw: content },
            });
            return {
                content: [
    ...
    async deletePullRequestComment(workspace, repo_slug, pull_request_id, comment_id) {
        try {
            ...
            await this.api.delete(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/comments/${comment_id}`);
            return {
    ...
    async getPullRequestDiffStat(workspace, repo_slug, pull_request_id) {
        try {
            ...
            const response = await this.api.get(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/diffstat`);
            return {
                content: [
    ...
    async getPullRequestPatch(workspace, repo_slug, pull_request_id) {
        try {
            ...
            const response = await this.api.get(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/patch`, {
    ...
    async getPullRequestTasks(workspace, repo_slug, pull_request_id) {
        try {
            ...
            const response = await this.api.get(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/tasks`);
            return {
                content: [
                    { type: "text", text: JSON.stringify(response.data.values, null, 2) },
                ],
    ...
    async createPullRequestTask(workspace, repo_slug, pull_request_id, content, commentId, state) {
        try {
            ...
            if (state)
                data.state = state;
            const response = await this.api.post(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/tasks`, data);
            return {
                content: [
                    { type: "text", text: JSON.stringify(response.data, null, 2) },
                ],
    ...
    async getPullRequestStatuses(workspace, repo_slug, pull_request_id) {
        try {
            ...
            const response = await this.api.get(`/repositories/${workspace}/${repo_slug}/pullrequests/${pull_request_id}/statuses`);
            return {
                content: [
                    { type: "text", text: JSON.stringify(response.data, null, 2) },
                ],
